...
:::
16. Sendo P, Q e R variáveis de tipo inteiro, com valores iguais a 2, 3 e 12, respectivamente, e uma variável real S, com valor de 4.5, quais os valores fornecidos por cada uma das expressões aritméticas abaixo?
...
22. Considerando A e C variáveis inteiras, contendo os valores, $1$ e $8$ e, B como uma variável real, com o valor $4.5$ e TESTE variável lógica contendo o valor verdadeiro (V), determinar os resultados obtidos da avaliação das seguintes expressões:
...
24. Sabendo que A = 5, B = 4, C = 3 e D = 6, informe se as expressões abaixo são verdadeiras ou falsas.
...
26. Elabore um programa que leia a altura de um andar do prédio e quantos andares o prédio possui. Calcule e mostre a altura do prédio.

27. Desenvolva um programa que leia um valor. Em seguida, deve ser mostrada a parte inteira da raiz quadrada do número lido.

28. Faça um programa que calcule a médio do peso de uma família que possui 5 pessoas.
...
1. A partir de um ângulo expresso em graus (º) , converta o valor do ângulo de graus para radianos ($rad$). Sabe-se que $\pi\ rad = 180º$ ([Vídeo: Convertendo de graus para radianos](https://www.youtube.com/watch?v=41S62_F5fl8)).
...
6. Desenvolva um programa para converter o valor de uma temperatura em graus Celsius ($C$) para graus Fahrenheit ($F$). Para essa conversão, temos a seguinte fórmula:
$$
F = \frac{9}{5}*C + 32
$$
