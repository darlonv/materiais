...
::: {.content-visible when-profile="java"}
  ...
  ```javascript
    public static void mostraValorMaisDez(int x){
        ...
        //highlight-next-line
        v = x+10;  //um valor é atribuído a v dentro da função
        System.out.println("V dentro do módulo: " + v);
    }
    ...
    public static void main(String[] args){
        ...
        //highlight-next-line
        v = 10; //um valor é atribuído a v fora da função
        System.out.println("V fora do módulo: " + v); //mostra o valor 10
        mostraValorMaisDez(v);                          //mostra o valor 20
        System.out.println("V fora do módulo: " + v); //mostra o valor 10. O valor original foi mantido.
    }
  ```
